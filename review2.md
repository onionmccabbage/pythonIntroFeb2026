...
- Think about architecture (maybe use separate functions, modules and imports)
  (dont have to - it can be one single file!!)
...
Ask the user for two integers, then retrieve all photos in that range
E.g. the user specifies 4 and 9, you retrieve photos with ID 4, 5, 6, 7, 8 and 9